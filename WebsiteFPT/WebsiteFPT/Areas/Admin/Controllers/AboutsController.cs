...
namespace WebsiteFPT.Areas.Admin.Controllers
{
    public class AboutsController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "ID_About,Name,MetaTitle,Description,Status,Created_At")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_About,Name,Description,Status,Created_At")] About about)
        {
            if (ModelState.IsValid)
            {
