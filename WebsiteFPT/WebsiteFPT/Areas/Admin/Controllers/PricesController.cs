...
namespace WebsiteFPT.Areas.Admin.Controllers
{
    public class PricesController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Price,Prices,PromotionPrice,Created_At")] Price price)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Price,Prices,PromotionPrice,Created_At")] Price price)
        {
            if (ModelState.IsValid)
            {
